...
function Toggle({
  ...
  size,
  ...props
}: ComponentProps<typeof TogglePrimitiveRoot> & VariantProps<typeof toggleVariants>) {
  return (
    <TogglePrimitiveRoot className={cn(toggleVariants({ variant, size }), className)} data-slot="toggle" {...props} />
  );
}
